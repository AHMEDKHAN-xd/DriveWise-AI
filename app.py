...
# ============================================================
# AI PROVIDER STATUS (checked once per session)
# ============================================================
...
def build_report_text(diagnosis):
    ...
    if diagnosis.get("ai_result"):
        ...
        lines.append(
            "The AI model returned an empty response for this "
            "report."
        )
    elif diagnosis.get("ai_status") == "offline":
        lines.append(
            "AI analysis was unavailable because no AI "
...
if diagnosis is not None:
    ...
    if ai_status == "ok":
        ...
        show_ai_unavailable(
            "The AI model returned an empty response. The "
            "knowledge-base results above are still available.",
            diagnosis.get("ai_error"),
        )
